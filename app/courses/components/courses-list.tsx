...
export default function CoursesList() {
  const courses = [
    {
      id: 1,
      title: 'CA & CMA Foundation Program',
      shortDesc: 'Complete coaching for CA and CMA Foundation with expert teachers.',
      duration: '9 months',
      students: '520+',
      level: 'Foundation',
      description: 'Structured foundation training for CA and CMA aspirants, including accounts, economics and law.',
      features: ['Revision tests', 'Doubt clearing live sessions', 'Result-oriented study plan'],
    },
    {
      id: 2,
      title: 'CMA Intermediate Accelerator',
      shortDesc: 'Fast-track CMA Inter coaching with focus on costing and financial management.',
      duration: '7 months',
      students: '360+',
      level: 'Inter',
      description: 'Targeted CMA Intermediate preparation with model answers, exam strategy and regular mock tests.',
      features: ['Practice papers', 'Performance review', 'Personal mentoring'],
    },
    {
      id: 3,
      title: 'CMA Final Mastery',
      shortDesc: 'Advanced CMA Final sessions for professional success.',
      duration: '8 months',
      students: '220+',
      level: 'Final',
      description: 'Comprehensive CMA Final coaching with expert faculty, case studies and doubt resolution.',
      features: ['Advanced case studies', 'Revision workshops', 'Exam-focused training'],
    },
    {
      id: 4,
      title: 'XI-XII Commerce Success',
      shortDesc: 'Class XI and XII coaching for CBSE, RBSE, ICSE and IB commerce streams.',
      duration: '12 months',
      students: '480+',
      level: 'Board',
      description: 'Complete commerce curriculum with Accounts, Economics, Business Studies and Computer Science support.',
      features: ['Weekly tests', 'Doubt clearing', 'Board exam strategy'],
    },
    {
      id: 5,
      title: 'CUET Commerce Prep',
      shortDesc: 'Dedicated CUET preparation for commerce aspirants with practice and review.',
      duration: '5 months',
      students: '200+',
      level: 'Entrance',
      description: 'High-impact CUET coaching with topic mastery, speed practice and confidence building.',
      features: ['Mock tests', 'Sectional drills', 'Performance tracking'],
    },
  ];
